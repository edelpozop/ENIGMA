...
- **~3,100 lines of code** C++17
- **13 source files** + 6 headers
- **4 complete example applications**
- **5 specialized generators** (Edge, Fog, Cloud, Builder, Base)
- **3 topologies per infrastructure type**
- **Complete documentation** (4 .md files)
- **IDE ready** (VS Code configuration included)

## 🎓 Documentation

- **[QUICKSTART.md](QUICKSTART.md)** - Get started in 5 minutes ⚡
- **[USAGE.md](USAGE.md)** - Complete usage guide 📚
- **[CLUSTER_USAGE.md](CLUSTER_USAGE.md)** - Cluster-based platforms guide 🔧
- **[ARCHITECTURE.md](ARCHITECTURE.md)** - Technical documentation 🏗️
- **[PROJECT_SUMMARY.md](PROJECT_SUMMARY.md)** - Project summary 📊
- **[KNOWN_ISSUES.md](KNOWN_ISSUES.md)** - Known limitations and workarounds ⚠️

## 🤝 Contributing

This project is extensible and modular. You can:
- Add new topologies
- Create new applications
- Improve existing generators
- Optimize algorithms
...
- **SimGrid Team** for the excellent simulation framework
- Edge/Fog/Cloud Computing Community
